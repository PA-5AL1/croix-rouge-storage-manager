...
import "./index.less";
import {FormationList, MapKey,} from "@/types"
import {addFormation, getFormation,} from "@/api/stock";

export default function SearchPage() {
  const [form] = Form.useForm();
  const [searchForm] = Form.useForm();
  const [pageData, setPageData] = useState<PageInfo>({ page: 1 });
  const [tableData, setData] = useState<FormationList>([]);
