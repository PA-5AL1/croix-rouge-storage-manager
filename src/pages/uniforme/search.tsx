...
import "./index.less";
import { MapKey, UniformeList,} from "@/types"
import { addUniforme, getUniforme,} from "@/api/stock";

export default function SearchPage() {
  const [form] = Form.useForm();
  const [searchForm] = Form.useForm();
  const [pageData, setPageData] = useState<PageInfo>({ page: 1 });
  const [tableData, setData] = useState<UniformeList>([]);
